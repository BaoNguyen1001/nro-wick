...
public class ItemService {
    ...
    public void openHopQuaCayChay(Player player, Item itemUse) {
        try {
            ...
            int randomElement = listQua.get(0);
            Item item = createNewItem((short) randomElement);
            item.itemOptions.add(new Item.ItemOption(50, Util.nextInt(22, 30)));
            item.itemOptions.add(new Item.ItemOption(77, Util.nextInt(22, 30)));
            item.itemOptions.add(new Item.ItemOption(103, Util.nextInt(22, 30)));
    ...
    public void openHopQuaDanChoi(Player player, Item itemUse) {
        try {
            ...
            item.itemOptions.add(new Item.ItemOption(48, Util.nextInt(20, 35)));
            item.itemOptions.add(new Item.ItemOption(5, Util.nextInt(5, 15))); // sức đánh chí mạng
